...
model.fit({'input': X}, {'targets': Y}, n_epoch=5, validation_set=({'input': test_x}, {'targets': test_y}), snapshot_step=50, 
...
with open('submission-file.csv', 'w') as p:
	p.write('id,label\n')
#the following segment of code is basically the saving of result in a csv and it is throwing so mainy disgusting errors!
